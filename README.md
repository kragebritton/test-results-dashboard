...
#### Backend tests + Allure reports

Install the optional test dependencies and run the FastAPI/pytest suite (Allure results are written to `backend/allure-results` by default):
...
If you have the [Allure CLI](https://docs.qameta.io/allure/#_installing_a_commandline) installed locally, you can render the report generated by the test run:
